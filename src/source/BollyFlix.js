  ...
  async handleInternal(ctx, _type, id) {
    ...
    try {
      streams = await Promise.race([
        ...
        // Task 59: budgets raised 20s/25s → 34s/34.5s (cold chains measured 33-34s). Production evidence
        ...
        withRetryOnEmpty(() => mod.getStreams(tmdbId.id, mediaType, tmdbId.season, tmdbId.episode), { maxTotalMs: 34000, tag: 'bollyflix' }),
